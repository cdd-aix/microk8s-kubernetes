...
Import-Module "$PSScriptRoot\libs\calico\calico.psm1" -Force
...
foreach ($service in (Get-Service | Where-Object Name -Like 'Calico*')){
    $service.WaitForStatus('Running', '00:00:30')
}

Write-Host "Done, the Calico services are running:"
Get-Service | Where-Object Name -Like 'Calico*'
